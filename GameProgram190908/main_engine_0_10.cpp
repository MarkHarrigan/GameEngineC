...
// Version 0.9 - Version that draws a yellow circle to the screen and moves it along the x-axis.  Basic x-oriented edge collision detection
...
// this builds up a 16 bit colour value in 5.5.5 format (1-bit alpha mode)

#define __RGB16BIT555(r,g,b) ((b & 31) + ((g & 31) << 5) + ((r & 31) << 10))

// This builds a 16 bit colour value in 5.6.5 format (green  dominate mode)
...
if (ddrval != DD_OK)
 {
	...
	{
		case DDERR_GENERIC:
			 OutputDebugString("BACKGROUND DDERR_GENERIC\n");
	         break;

		case DDERR_INVALIDCLIPLIST:
			 OutputDebugString("BACKGROUND DDERR_INVALIDCLIPLIST\n");
			 break;

		case DDERR_INVALIDOBJECT:
			 OutputDebugString("BACKGROUND DDERR_INVALIDOBJECT\n");
			 break;

		case DDERR_INVALIDPARAMS:
			 OutputDebugString("BACKGROUND DDERR_INVALIDPARAMS\n");
			 break;
 
		case DDERR_INVALIDRECT:
			 OutputDebugString("BACKGROUND DDERR_INVALIDRECT\n");
			 break;
 
		case DDERR_NOALPHAHW:
			 OutputDebugString("BACKGROUND DDERR_NOALPHAHW\n");
			 break;
 
		case DDERR_NOBLTHW:
			 OutputDebugString("BACKGROUND DDERR_NOBLTHW\n");
			 break;	
 
		case DDERR_NOCLIPLIST:
			 OutputDebugString("BACKGROUND DDERR_NOCLIPLIST\n");
			 break;
 
		case DDERR_NORASTEROPHW:
			 OutputDebugString("BACKGROUND DDERR_NORASTEROPHW\n");
			 break;
 
		case DDERR_NOSTRETCHHW:
			 OutputDebugString("BACKGROUND DDERR_NOSTRETCHHW\n");
			 break;
 
		case DDERR_SURFACEBUSY:
			 OutputDebugString("BACKGROUND DDERR_SURFACEBUSY\n");
			 break;
 
		case DDERR_SURFACELOST:
			 OutputDebugString("BACKGROUND DDERR_SURFACELOST\n");
			 break;
 
		case DDERR_UNSUPPORTED:
			 OutputDebugString("BACKGROUND DDERR_UNSUPPORTED\n");
			 break;
 
		case DDERR_WASSTILLDRAWING:
			 OutputDebugString("BACKGROUND DDERR_WASSTILLDRAWING\n");
			 break;
...
if (ddrval != DD_OK)
 {
	...
	{
		case DDERR_GENERIC:
			 OutputDebugString("BMP DDERR_GENERIC\n");
	         break;

		case DDERR_INVALIDCLIPLIST:
			 OutputDebugString("BMP DDERR_INVALIDCLIPLIST\n");
			 break;

		case DDERR_INVALIDOBJECT:
			 OutputDebugString("BMP DDERR_INVALIDOBJECT\n");
			 break;

		case DDERR_INVALIDPARAMS:
			 OutputDebugString("BMP DDERR_INVALIDPARAMS\n");
			 break;
 
		case DDERR_INVALIDRECT:
			 OutputDebugString("BMP DDERR_INVALIDRECT\n");
			 break;
 
		case DDERR_NOALPHAHW:
			 OutputDebugString("BMP DDERR_NOALPHAHW\n");
			 break;
 
		case DDERR_NOBLTHW:
			 OutputDebugString("BMP DDERR_NOBLTHW\n");
			 break;	
 
		case DDERR_NOCLIPLIST:
			 OutputDebugString("BMP DDERR_NOCLIPLIST\n");
			 break;
 
		case DDERR_NORASTEROPHW:
			 OutputDebugString("BMP DDERR_NORASTEROPHW\n");
			 break;
 
		case DDERR_NOSTRETCHHW:
			 OutputDebugString("BMP DDERR_NOSTRETCHHW\n");
			 break;
 
		case DDERR_SURFACEBUSY:
			 OutputDebugString("BMP DDERR_SURFACEBUSY\n");
			 break;
 
		case DDERR_SURFACELOST:
			 OutputDebugString("BMP DDERR_SURFACELOST\n");
			 break;
 
		case DDERR_UNSUPPORTED:
			 OutputDebugString("BMP DDERR_UNSUPPORTED\n");
			 break;
 
		case DDERR_WASSTILLDRAWING:
			 OutputDebugString("BMP DDERR_WASSTILLDRAWING\n");
			 break;
...
colour_key.dwColorSpaceHighValue = __RGB16BIT565(0,0,0);
colour_key.dwColorSpaceLowValue = __RGB16BIT565(0,0,0);
...
ddsd.ddckCKSrcBlt.dwColorSpaceHighValue = __RGB16BIT565(0,0,0);
ddsd.ddckCKSrcBlt.dwColorSpaceLowValue = __RGB16BIT565(0,0,0);
...
if(FAILED(lpddsbackground->SetColorKey(DDCKEY_SRCBLT, &colour_key)))
{
...
if(FAILED(lpddsbmp->SetColorKey(DDCKEY_SRCBLT, &colour_key)))
{
	OutputDebugString("Cant set colour key for back surface.\n");
	return(0);
...
if(FAILED(lpddsback->SetColorKey(DDCKEY_SRCBLT, &colour_key)))
{
	OutputDebugString("Cant set colour key for back surface.\n");
	return(0);
